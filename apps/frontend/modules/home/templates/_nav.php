<div id="nav">
    <nav>
	<ul>
	    <li class="high"><a href="#" class="home"><span>home</span></a></li>
	    <li class="high"><a href="#" class="about"><span>home</span></a></li>
	    <li class="high"><a href="#" class="done"><span>home</span></a></li>
