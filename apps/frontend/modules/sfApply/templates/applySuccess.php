...
<div class="sf_apply sf_apply_apply parentAjaxFormSubmit">
  <form class="form ajaxFormSubmit" method="post" action="<?php echo url_for('sfApply/apply') ?>" name="sf_apply_apply_form" id="sf_apply_apply_form">
    <div class="grid-5-12 form-right">
      ...
      <?php endforeach; ?>
      <div class="grid-9-12 form-right">
        <input class="form-button" type="submit" value="<?php echo __("Create My Account", array(), 'sfForkedApply') ?>" />
      </div>
    </div>
  </form>
</div>